---
layout: blog.liquid
title: What happened in 2025
description: More drawing, freelance work, homesteading losses, and learning to share what I make.
tags: ["post","journal"]
date: 2026-03-01
---
...
I leaned heavily into [drawing](/art/). That wasn't part of the plan, but here we are.
...
{% image "img/playground-in-snow-1-18-25.jpg", "Pen and inkwash drawing of a park in winter, in Essex, Vermont,  covered in snow with trees and a picnic table.", "The sketch that unlocked that drawing could be my thing again" %}
...
I've become the local tech guy. I built a website for [Jericho Underhill Food Hub](https://www.jufoodhub.org/), by helping them set up their donation infrastructure and choosing the right tools. I created a logo for [West Farm](https://thefarmbetween.com/west-farm-csa), a place in Jeffersonville where we're getting a winter CSA. Small projects are all I can fit in these days. Freelance work like this has been a nice break from enterprise-sized projects. 
...
{% image "img/tent-summer.jpg", "Photo of a lush green yard with a picnic table from inside a tent.", "Summer camp" %}
{% image "img/tent-winter.jpg", "Photo of a small tent in a yard of snow, with long shadows indicating sunset coming near", "Winter camp" %}
...
{% image "img/berries.jpg", "Zoomed in photo of many types of berries in a plastic container", "blueberries, black currants, red currants, black raspberries" %}
...
I'm halfway through Pynchon's Gravity's Rainbow. It's the kind of book that demands you show up, and I'm only still in it because of the secondary, podcast support from [Slow Learners](https://podcasts.apple.com/us/podcast/slow-learners/id1712289025). There's a lot of support you can choose from for a book with fandom like GR. These fellas struck a chord with me. They also maintain this mega-guide: [Proverbs for paranoids](https://www.gravitysrainbowguide.com/). This quote sums up the tome for the unititiated: 
